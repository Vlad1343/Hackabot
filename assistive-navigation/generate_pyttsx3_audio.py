...
def phrase_catalog() -> dict[str, dict[str, str]]:
    ...
    outdoor = {
        ...
        "bus_ahead": "Bus ahead",
        "bus_left": "Bus on your left",
        "bus_right": "Bus on your right",
        "several_bus_ahead": "Several buses ahead",
        "several_bus_left": "Several buses on your left",
        "several_bus_right": "Several buses on your right",
        ...
        "red_light": "Wait, red light",
        "green_light": "Safe to cross, green light",
        "safe_to_cross": "Safe to cross",
        "path_clear": "Path is clear",
        "turn_slightly_left": "Turn left",
        "turn_slightly_right": "Turn right",
    }
