...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--no-flip", action="store_true", help="Disable default horizontal camera flip")
    parser.add_argument("--mirror-input", dest="mirror_input", action="store_true", default=None, help="Force mirrored camera input")
    parser.add_argument("--no-mirror-input", dest="mirror_input", action="store_false", help="Force non-mirrored camera input")
